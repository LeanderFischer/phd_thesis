...
\begin{figure*}[h]
    \includegraphics[width=0.65\linewidth]{figures/results/best_fit/pid_data_mc_agreement.png}
    \includegraphics[width=0.65\linewidth]{figures/results/best_fit/reco_coszen_data_mc_agreement.png}
