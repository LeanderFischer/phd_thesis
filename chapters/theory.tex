...
The standard cosmological model $\Lambda$CDM \sidecite{relativity_in_modern_physics}, includes a non-baryonic matter species referred to as \textit{cold dark matter (CDM)} that is responsible for the observed large-scale structure of the universe and accounts for \SI{84.4}{\percent} of the total matter density in the universe \sidecite{PDG_review_2022}. Despite its effects being observed at several cosmological scales, from the size of small galaxies \sidecite{faint_galaxy_dm_2019ARA&A..57..375S} to groups of galaxies \sidecite{galaxy_clusters_2011ARA&A..49..409A}, the nature of CDM is still unknown.
