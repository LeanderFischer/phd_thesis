...
\todo{Note here why neutrinos do not have mass because of this!?}
...
There are no right-handed neutrinos in the SM and therefore the mass mechanism described in \refsec{fermion_masses}, which couples the Higgs field to left-handed and right-handed Weyl spinors, predicts them to be massless. From experimental observations it is known that at least two of the three neutrino generations need to have a non-zero mass.
