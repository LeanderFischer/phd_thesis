...
\begin{figure*}[h]
    \includegraphics{figures/hnl_simulation/theory/UeN_majorana.png}
      \caption[Current $|U_{e4}^2|-m_4$ limits]{Current $|U_{e4}^2|-m_4$ limits from xx. Modified from \cite{hoster_limitFernandez-Martinez:2023phj}.}
    \labfig{boundsUe}
\end{figure*}
\todo{fix caption and check I mentioned all experiments (RED)}

\begin{figure*}[h]
    \includegraphics{figures/hnl_simulation/theory/UmuN_majorana.png}
      \caption[Current $|U_{\mu4}^2|-m_4$ limits]{Current $|U_{\mu4}^2|-m_4$ limits from xx. Modified from \cite{hoster_limitFernandez-Martinez:2023phj}.}
    \labfig{boundsUe}
\end{figure*}
\todo{fix caption and check I mentioned all experiments (RED)}
...
\begin{figure*}[h]
    \includegraphics{figures/hnl_simulation/theory/UtauN_majorana.png}
      \caption[Current $|U_{\tau4}^2|-m_4$ limits]{Current $|U_{\tau4}^2|-m_4$ limits from xx. Modified from \cite{hoster_limitFernandez-Martinez:2023phj}.}
    \labfig{boundsUe}
\end{figure*}
\todo{fix caption and check I mentioned all experiments (RED)}
...
%     \caption[Current $|U_{\tau4}^2|-m_4$ limits]{Current $|U_{\tau4}^2|-m_4$ limits from NOMAD \cite{NOMAD:2001eyx}, ArgoNeut \cite{ArgoNeuT:2021clc}, CHARM \cite{Orloff:2002de, Boiarska:2021yho}, and DELPHI \cite{DELPHI:1996qcc}. Data taken from the colleciton of \cite{hoster_limitFernandez-Martinez:2023phj}.}
%   \labfig{boundsUtau}
% \end{figure}
...
\end{figure}
\todo{fix up-scattering feynman diagram and put into the margin (RED)}
...
%     \labfig{HNL_decay}
% \end{figure}
\todo{fix the decay feynman diagrams and put into the margin (RED)}
