...
\todo{Adapt chapter to reflect switched chapter order}
...
\todo{SB:
I think its better to discuss the sources of uncertainty when you introduce each component, e.g. when you talk about cross-sections you can explain the existing measurements and models, and how the uncertainty is derived. Same for the detector calibration uncertainties - you can discuss the manitude of the errors and how they are derived when you discuss the detector.
}
