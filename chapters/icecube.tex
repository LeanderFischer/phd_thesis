...
\begin{subequations}
    ...
    \end{align}
\end{subequations}
The maximum of the shower is at $t_{max} = (a-1)/b$ and the Cherenkov emission of the charged particles produced in the shower is peaked around the Cherenkov angle, since they are produced in the forward direction. \reffig{cherenkov_shower_profile} shows the angular shower profile of an EM shower from an electron, which peaks sharply around the Cherenkov angle.

\begin{marginfigure}
    \centering
    \input{figures/icecube_deepcore/angular_shower_distribution.tex}
