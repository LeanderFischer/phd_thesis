...
\todo{get trigger efficiency (SMT-3) for HNL as a plot or just the number? (RED)}
...
\todo{add table with selection efficiencies SM (in flavors) and HNL (RED)}
...
\todo{Plot energy (true total) and true decay length across the different levels (take efficiencies from this) (RED)}
