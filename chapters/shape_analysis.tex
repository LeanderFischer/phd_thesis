...
\todo{Plot updates: change 0.6 GeV color, sort variables by type (same as table), offset markers left/right, change grid lines to separate the parameter region, ylabel limit instead of range (RED)}
